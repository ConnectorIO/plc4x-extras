 ...
 */
package org.connectorio.plc4x.extras.decorator.noop;
...
public class NoopUnsubscribeDecorator implements UnsubscribeDecorator {

  @Override
  public Builder decorateUnsubscribe(Builder delegate) {
    return delegate;
  }
